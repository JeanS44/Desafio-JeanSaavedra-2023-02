...
@section('addButton')
    @can('crear-permiso')
        <div class="d-flex text-center">
            <a class="btn btn-primary" href="{{ route('permissions.create') }}"><i class="bi bi-plus"></i></a>
        </div>
    @endcan
@endsection
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-3">
                                    @can('editar-permiso')
                                        <a class="btn btn-success" href="{{ route('permissions.edit', $permission->id) }}">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                    @endcan
                                    @can('mostrar-permiso')
                                        <a class="btn btn-primary" href="{{ route('permissions.show', $permission) }}">
